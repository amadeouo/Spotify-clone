...
export const AddAlbumDialog = () => {
  const [isAlbumDialogOpen, setAlbumDialogOpen] = useState<boolean>(false)
  const [isLoading, setIsLoading] = useState<boolean>(false)
  const fileInputRef = useRef<HTMLInputElement>(null)

  const [newAlbum, setNewAlbum] = useState<SendAlbumState>({
    title: '',
    artist: '',
  ...
  return (
    <Dialog open={isAlbumDialogOpen} onOpenChange={setAlbumDialogOpen}>
